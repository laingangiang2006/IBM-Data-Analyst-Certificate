...
app.layout = html.Div([
    ...
    html.P(
        ...
        style={'textAlign': 'center', 'color': '#503D36', 'font-size': 16}
    ),
...
# Callback 1: Enable/disable the year dropdown based on report type selected
@app.callback(
...
# Callback 2: Update the output container with the relevant graphs
@app.callback(
